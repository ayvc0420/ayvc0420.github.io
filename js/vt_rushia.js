;(function(){
	...
	window.addEventListener('scroll', function () {
		...
		const vt_control_vt_audio_title =
			vt_audio_title_top - height <= now_height - 100;
		const vt_control_rushia_audio_clock =
			rushia_audio_clock_top - height <= now_height - 150;
	...
	function rushiaClock() {
		...
		let t =
			rushiaVolume.value <= 1 &&
			rushiaVolume.value != '0' &&
			rushiaVolume.value >= 0;
